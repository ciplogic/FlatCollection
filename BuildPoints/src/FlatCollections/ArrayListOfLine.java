...
public class ArrayListOfLine {
    ...
    public ArrayListOfLine() {
        setCapacity(10);
    }
    public ArrayListOfLine(int capacity) {
    ...
    public FlatCursorLine getCursor(){
        return new FlatCursorLine(this, _size);
    }
